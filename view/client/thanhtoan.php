				...
				<form class="new-account-box primari-box" id="create-new-account" method="post"
					...
					<div class="form-content">
						...
						<div class="form-group primary-form-group">
							...
							<input type="text" value="" name="ten_user" id="ten_user" class="form-control" required>
						</div>
						<div class="form-group primary-form-group">
							<label for="email">Địa chỉ</label>
							<input type="text" value="" name="diachi" id="diachi" class="form-control" required>
						</div>
						<div class="form-group primary-form-group">
						...
						<div class="form-group primary-form-group">
							...
							<input type="text" value="" name="sdt" id="sdt" class="form-control" required>
						</div>
						<div class="form-group primary-form-group">
							<br>
